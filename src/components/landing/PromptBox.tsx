  ...
  return (
    <div className="tp-rise" style={{ animationDelay: "0.25s" }}>
      <form
        ...
        className="mt-[34px] flex items-center gap-4 rounded-[20px] bg-white p-[11px] pl-5 text-left shadow-[0_34px_80px_-34px_rgba(6,28,45,.85),0_0_0_1px_rgba(255,255,255,.5)]"
      >
        ...
        <button
          type="submit"
          className="tp-btn inline-flex flex-none items-center gap-2.5 rounded-[14px] bg-[linear-gradient(150deg,#2f7fb0,#134a6f)] px-6 py-[15px] text-[15px] font-bold text-white shadow-[0_16px_30px_-14px_rgba(15,58,88,.9)]"
        >
          Plan my trip

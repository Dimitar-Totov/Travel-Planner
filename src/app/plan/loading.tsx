 ...
 * So it draws the *same* silhouette as the page it replaces — the nav, the
 * viewport-filling `lg` split, the reading column's hero / byline / intro /
 * stats / tips / day accordions, and a flat map pane beside them — and the swap
 * to the real itinerary is a fill-in rather than a re-layout.
 *
 ...
 *
 * There is no footer: the real page only shows one below `lg`, under a column
 ...
 *  loop, so the count here has to stay at five. */
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white lg:h-screen lg:overflow-hidden">
      ...
      <p role="status" className="sr-only">
        Building your trip plan — choosing where to go, routing your days and
        picking the stops. This usually takes a few seconds.
      </p>
